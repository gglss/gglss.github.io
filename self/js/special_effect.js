...
$.ajax({
    ...
    data: {
        key: 'D75BZ-LJMCN-37FFB-SWMHF-VWEBQ-2MFBV',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    //自定义文本需要放的位置
    document.getElementById("welcome-info").innerHTML = `欢迎来自<span>${pos}</span>的小伙伴，${timeChange}<br>你距离博主约有<span>${dist}</span>公里，${posdesc}`;
}
